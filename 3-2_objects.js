...
// Calculate the total age of all the people
let totalAge = 0;
...
// Section 8: Combining Hobbies using Spread Syntax (...)

// spread syntax lets us access the elements inside of the array, rather than the array itself
...
// Section 9: Adding new key value pairs to an object array

for (let person of people) {
  person.discount = person.isMember ? "$10" : "$0";
}
